...
import {L2_INTEROP_CENTER_ADDR} from "../lib/era-contracts/l1-contracts/contracts/common/l2-helpers/L2ContractAddresses.sol";
...
contract InteropE2EBundle is Script {
    ...
    IInteropCenter public destinationInteropCenter;
    ...
    //     // interopCenter = new InteropCenter();
    //     interopCenter = IInterpCenter(L2_INTEROP_CENTER_ADDR);
    //     console2.log("Deployed InteropCenter at:", address(interopCenter));
