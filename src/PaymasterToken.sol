...
// import {IInteropCenter} from "l1-contracts/bridgehub/IInteropCenter";
import {IInteropCenter} from "../lib/era-contracts/l1-contracts/contracts/bridgehub/IInteropCenter.sol";
import {IInteropHandler} from "../lib/era-contracts/l1-contracts/contracts/bridgehub/IInteropHandler.sol";
import {L2_INTEROP_HANDLER_ADDR} from "../lib/era-contracts/l1-contracts/contracts/common/l2-helpers/L2ContractAddresses.sol";
...
contract PaymasterToken is ERC20, Ownable {
    ...
    function addOtherBridge(
        ...
        address aliasedAddress = IInteropHandler(L2_INTEROP_HANDLER_ADDR)
    ...
    function sendToRemote(
        ...
        // IInteropCenter(interopAddress).addCallToBundle(
        //     bundleId,
        //     destinationChainId,
        //     destinationAddress,
        //     payload,
